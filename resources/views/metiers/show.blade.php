        ...
        <div
            ...
            <div class="dropdown no-arrow">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                    ...
                    <a class="dropdown-item" href="{{route('metiers.edit', $metier->id)}}">Modifier</a>
        ...
        <div class="card-body">
            <div class="form-group col-xl-12 col-perso">
                <input type="text" class="form-control form-control-user input-perso"
                       placeholder="Intitulé" value="{{$metier->libelle}}" readonly>
            </div>
            <div class="form-group col-xl-12 col-perso">
                <input type="text" class="form-control form-control-user input-perso"
                       placeholder="Slug" value="{{$metier->slug}}" readonly>
            </div>
            <div class="form-group col-xl-12 col-perso">
                <textarea class="form-control form-control-user input-perso"
                          placeholder="Description" rows="5" cols="50" readonly>{{$metier->description}}
                </textarea>
            </div>
