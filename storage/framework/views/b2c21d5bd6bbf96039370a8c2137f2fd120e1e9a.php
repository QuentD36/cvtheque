<?php $__env->startSection("contenu"); ?>
    ...
    <div class="card shadow mb-4">
        ...
        <!-- Card Body -->
        <div class="card-body">
            <form method="post" action="<?php echo e(route('competences.update',array('competence' => $competence->id))); ?>">
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="Intitulé" value="<?php echo e(old('intitule',$competence->intitule)); ?>" name="intitule">
...
unset($__errorArgs, $__bag); ?>" rows="5" cols="50" name="description" placeholder="Description"><?php echo e(old('description', $competence->description)); ?></textarea>
...
<?php echo $__env->make('cvtheque', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\cvtheque\resources\views/competences/edit.blade.php ENDPATH**/ ?>