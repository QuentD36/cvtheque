<?php $__env->startSection("contenu"); ?>
    ...
    <div class="card shadow mb-4">
        ...
        <!-- Card Body -->
        <div class="card-body">
            <form method="post" action="<?php echo e(route('professionnels.update', $professionnel->id)); ?>">
...
unset($__errorArgs, $__bag); ?>" name="metier_id">
                        <option value="" <?php if(old('metier_id') == '' || $professionnel->metier_id == ''): ?> selected <?php endif; ?>>
                            Choix du métier
                        </option>
                        <?php $__currentLoopData = $metiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($metier->id); ?>" <?php if(old('metier_id') == $metier->id || $professionnel->metier_id == $metier->id): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                    <div class="radio-container offset-xl-2">
                        ...
                        <div class="radio-content custom-radio">
                            <input class="custom-radio" type="radio" value="1" name="formation" <?php if(old('formation', $professionnel->formation) == 1): ?> checked <?php endif; ?>>
                            <label for="oui">Oui</label>
                            <input class="custom-radio" type="radio" value="0" name="formation"  <?php if(old('formation', $professionnel->formation) == 0): ?> checked <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="Nom" value="<?php echo e(old('nom', $professionnel->nom)); ?>" name="nom">
                    <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="Prénom" value="<?php echo e(old('prenom', $professionnel->prenom)); ?>" name="prenom">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group col-xl-12 col-perso">
                    <input <?php if(old('naissance') != '' || $professionnel->naissance != ''): ?> type="date" <?php else: ?> type="text" <?php endif; ?> class="input-perso form-control form-control-user <?php $__errorArgs = ['naissance'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="Date de naissance" value="<?php echo e(old('naissance', $professionnel->naissance)); ?>" name="naissance" onfocus="(this.type='date')">
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="Code postal" value="<?php echo e(old('cp', $professionnel->cp)); ?>" name="cp">
                    <?php $__errorArgs = ['cp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="Ville" value="<?php echo e(old('ville', $professionnel->ville)); ?>" name="ville">
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="Téléphone" value="<?php echo e(old('telephone', $professionnel->telephone)); ?>" name="telephone">
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="E-mail" value="<?php echo e(old('email', $professionnel->email)); ?>" name="email">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group col-xl-12 col-perso">
                    <div class="checkbox-container" >
                        ...
                        <input type="checkbox" id="reseaux" name="domaine[]" value="R" <?php echo e((is_array(old('domaine', $professionnel->domaine)) && in_array('R', old('domaine', $professionnel->domaine))) ? 'checked' : ''); ?>>
                        <label for="systemes">Systèmes</label>
                        <input type="checkbox" id="systemes" name="domaine[]" value="S" <?php echo e((is_array(old('domaine', $professionnel->domaine)) && in_array('S', old('domaine', $professionnel->domaine))) ? 'checked' : ''); ?>>
                        <label for="developpement">Développement</label>
                        <input type="checkbox" id="developpement" name="domaine[]" value="D" <?php echo e((is_array(old('domaine', $professionnel->domaine)) && in_array('D', old('domaine', $professionnel->domaine))) ? 'checked' : ''); ?>>
                    </div>
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="Source" value="<?php echo e(old('source', $professionnel->source)); ?>" name="source">
...
unset($__errorArgs, $__bag); ?> col-xl-6" name="comp[]">
                        <?php $__currentLoopData = $competences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $competence): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($competence->id); ?>"
                                <?php echo e(in_array($competence->id,old('comp') ? old('comp') : $professionnel->competences->pluck('id')->toArray()) ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?>" rows="5" cols="50" name="observation" placeholder="Observation"><?php echo e(old('observation', $professionnel->observation)); ?></textarea>
...
<?php echo $__env->make('cvtheque', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\cvtheque\resources\views/professionnels/edit.blade.php ENDPATH**/ ?>